...
Append a package to a Jarvis-CD pipeline.

**Usage Example:**
```python
# Use append_pkg function
result = append_pkg()
print(result)
```
...
Configure a package in a Jarvis-CD pipeline.

**Usage Example:**
```python
# Use configure_pkg function
result = configure_pkg()
print(result)
```
...
Unlink a package from a Jarvis-CD pipeline (preserve files).

**Usage Example:**
```python
# Use unlink_pkg function
result = unlink_pkg()
print(result)
```
...
Remove a package entirely from a Jarvis-CD pipeline.

**Usage Example:**
```python
# Use remove_pkg function
result = remove_pkg()
print(result)
```
...
Destroy a Jarvis-CD pipeline environment and clean up files.

**Usage Example:**
```python
# Use destroy_pipeline function
result = destroy_pipeline()
print(result)
```
...
Initialize JarvisManager config directories.

**Usage Example:**
```python
# Use jm_create_config function
result = jm_create_config()
print(result)
```
...
Load existing JarvisManager configuration.

**Usage Example:**
```python
# Use jm_load_config function
...
Save current JarvisManager configuration.

**Usage Example:**
```python
# Use jm_save_config function
...
Set hostfile path for JarvisManager.

**Usage Example:**
```python
# Use jm_set_hostfile function
result = jm_set_hostfile()
print(result)
```
...
Bootstrap Jarvis config from a machine template.

**Usage Example:**
```python
# Use jm_bootstrap_from function
result = jm_bootstrap_from()
print(result)
```
...
List available bootstrap machine templates.

**Usage Example:**
```python
# Use jm_bootstrap_list function
...
Reset JarvisManager (destroy all pipelines and data).

**Usage Example:**
```python
# Use jm_reset function
result = jm_reset()
print(result)
```
...
List all existing Jarvis pipelines.

**Usage Example:**
```python
# Use jm_list_pipelines function
...
Change current Jarvis pipeline context.
...
Add a repository to JarvisManager.

**Usage Example:**
```python
# Use jm_add_repo function
result = jm_add_repo()
print(result)
```
...
**Usage Example:**
```python
# Use jm_remove_repo function
result = jm_remove_repo()
print(result)
```
...
Promote a repository in JarvisManager.

**Usage Example:**
```python
# Use jm_promote_repo function
result = jm_promote_repo()
print(result)
```
...
Get repository info from JarvisManager.

**Usage Example:**
```python
# Use jm_get_repo function
result = jm_get_repo()
print(result)
```
...
Construct a package skeleton in JarvisManager.

**Usage Example:**
```python
# Use jm_construct_pkg function
result = jm_construct_pkg()
print(result)
```
...
Print the current resource graph frames.

**Usage Example:**
```python
# Use jm_graph_show function
...
Build or rebuild the resource graph with a net sleep interval.

**Usage Example:**
```python
# Use jm_graph_build function
result = jm_graph_build()
print(result)
```
...
Modify the resource graph using a net sleep interval.

**Usage Example:**
```python
# Use jm_graph_modify function
result = jm_graph_modify()
print(result)
```
